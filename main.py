...
"""
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "/menu", "commands"):
                            ...
                            # Header
                            header = """[B][C][FFFF00]✨ BLACK666FF PRIVATE BOT ✨
...
-> [FFFFFF]Join Req Pro Badge"""
                            ...
                            await asyncio.sleep(0.2)
                                                        ...
                                                        # Footer
                            footer = """[C][B][1E90FF]╭━━━━━━━━━╮
[1E90FF]┃ [FFFFFF]CREDITS: BLACK666FF[1E90FF]
...
async def MaiiiinE():
    Uid , Pw = '4228952629','JOBAYAR_CODX-ETKCAQ0G2'
    ...
    os.system('clear')
    print("Initializing BLACK666FF Bot...")
    print("┌────────────────────────────────────┐")
    print("│ █████████████░░░░░░░░░░░░░░░░░░ │")
    print("└────────────────────────────────────┘")
    time.sleep(0.5)
...
def handle_keyboard_interrupt(signum, frame):
    ...
    print("👋 Thanks for using BLACK666FF Bot!")
    sys.exit(0)
